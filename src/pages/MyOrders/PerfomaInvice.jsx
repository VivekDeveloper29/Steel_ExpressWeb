...
function PerfomaInvice() {
  ...
  let getSendgridDetail = () => {
    simpleGetCallWithErrorResponse(
      ApiConfig.SENDGRID_PRO_FORMA_GENRATE + id
    ).then((res) => {
      console.log(res);
      ...
      <div className="main-order-details"  >
        ...
        <section className="order-stepper" >
          ...
          <div style={{ "margin-left": "700px" }}>
            <button class="btn" onClick={createPdf}><i class="fa fa-download"></i>Download proforma invoice</button>
            {/* <button class="btn" onClick={createPdf}><i class="fa fa-download"></i>Download invoice</button> */}
          </div>

          <div id="table" >
            <div style={{ "background-color": "white" ,padding: "20px" }}  id="my-node">
              <b style={{ "background-color": "white", "margin-left":"380px"}} >PROFORMA INVOICE</b>
              <br></br>
              <img style={{ "margin-left": "300px" }} src={logo_new} alt height={100} width={200} />
              <br></br>

              <b> Dear {userDetails.full_name} , </b>
              <p> Thanks for placing order with us. Below is the PI. Kindly proceed with the payment. </p><hr></hr>
