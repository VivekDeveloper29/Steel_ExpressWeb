...
function Sendinovice() {
  ...
  let getSendgridDetail = () => {
    simpleGetCallWithErrorResponse(
      ApiConfig.SENDGRID_INOVICE_GENRATE + id
    ).then((res) => {
      console.log(res);
      ...
      <div className="main-order-details"  >
        ...
        <section className="order-stepper" >
          ...
          <div id="table" >
            ...
            <b style={{ "background-color": "white", "margin-left":"350px"}} >INVOICE</b>
              <br></br>
              <img style={{ "margin-left": "300px" }} src={logo_new} alt height={100} width={200} />
              <br></br>

              <b> Dear {userDetails.full_name} , </b>
              <p>Please find the invoice below for your reference. </p><hr></hr>
